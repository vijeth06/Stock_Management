...
router.post("/transfers/:transferId/approve", authorize(["Administrator", "AuditOfficer", "DepartmentUser"]), assetController.approveTransfer);
router.post("/transfers/:transferId/reject", authorize(["Administrator", "AuditOfficer", "DepartmentUser"]), assetController.rejectTransfer);
