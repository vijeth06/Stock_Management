...
router.post("/transfers/:transferId/approve", authorize(["Administrator", "AuditOfficer"]), assetController.approveTransfer);
router.post("/transfers/:transferId/reject", authorize(["Administrator", "AuditOfficer"]), assetController.rejectTransfer);
